 ...
 */
contract ZappCheckoutIntegrator is IP2PIntegrator, Ownable2Step {
    ...
    ///         `setBlocked`, the cap setters, attestor rotation and
    ///         `sweepUsdc`. Hand over control with `transferOwnership`.
